...
public:
   ...
   struct get_info_results {
      ...
      optional<chain::previous_backup_info>  head_previous_backup_block;
   };
...
FC_REFLECT( eosio::chain_apis::read_only::get_account_results,
            (account_name)(creator)(head_block_num)(head_block_time)(privileged)(last_code_update)(created)
