...
namespace amaxbasic {
   ...
   /**
    * The `amax.basic` is the first sample of system contract provided by `block.one` through the AMAX platform. It is a minimalist system contract because it only supplies the actions that are absolutely critical to bootstrap a chain and nothing more. This allows for a chain agnostic approach to bootstrapping a chain.
    * 
    ...
    * amax.basic is same as amax.bios except setprods to avoid WASM Exception "env.set_proposed_producers_ex unresolveable"
    */
   class [[eosio::contract("amax.basic")]] amax_basic : public eosio::contract {
      public:
          ...
          * become "active".
          * @note this is old version setprods
         ...
         using newaccount_action = action_wrapper<"newaccount"_n, &amax_basic::newaccount>;
         using updateauth_action = action_wrapper<"updateauth"_n, &amax_basic::updateauth>;
         using deleteauth_action = action_wrapper<"deleteauth"_n, &amax_basic::deleteauth>;
         using linkauth_action = action_wrapper<"linkauth"_n, &amax_basic::linkauth>;
         using unlinkauth_action = action_wrapper<"unlinkauth"_n, &amax_basic::unlinkauth>;
         using canceldelay_action = action_wrapper<"canceldelay"_n, &amax_basic::canceldelay>;
         using setcode_action = action_wrapper<"setcode"_n, &amax_basic::setcode>;
         using setabi_action = action_wrapper<"setabi"_n, &amax_basic::setabi>;
         using setpriv_action = action_wrapper<"setpriv"_n, &amax_basic::setpriv>;
         using setalimits_action = action_wrapper<"setalimits"_n, &amax_basic::setalimits>;
         using setparams_action = action_wrapper<"setparams"_n, &amax_basic::setparams>;
         using reqauth_action = action_wrapper<"reqauth"_n, &amax_basic::reqauth>;
         using activate_action = action_wrapper<"activate"_n, &amax_basic::activate>;
         using reqactivated_action = action_wrapper<"reqactivated"_n, &amax_basic::reqactivated>;
   };
}
