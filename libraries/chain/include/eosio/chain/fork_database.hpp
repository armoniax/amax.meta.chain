...
namespace eosio { namespace chain {
   ...
   class fork_database {
      public:
         ...
         block_header_state_ptr  get_block_header( const block_id_type& id , bool finding_root_previous = false )const;
          ...
          */
         void            reset( const block_header_state& root_bhs, const block_header_state* root_previous_bhs = nullptr );
         ...
         const block_state_ptr& root_previous()const;
